...
async def get_body_tree(robot_name: str, generator_type: str):
    ...
    try:
        ...
        result["robot"] = {
            "bodies": robot.hrdf.body_names,
            "joints": robot.hrdf.joint_names
        }
    except Exception as e:
        result["robot"] = {"error": str(e)}

    # Get human body names (placeholder - requires motion file)
    result["human"] = {
        "note": "Human body names require a motion file to be loaded"
    }

...
@click.option('--config-name', default='default', help='Name of configs.', prompt="Name of configs")
...
def main(source_file_path, robot_name, generator_type, config_name, view, speed, offset):
